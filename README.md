...
command argument bridging, Canvas drawing/image/window item creation, discovery, movement, coordinate conversion, and scrolling view control, image-backed widget
