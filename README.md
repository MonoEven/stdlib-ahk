...
command argument bridging, Canvas line/rectangle/oval/polygon/text/arc/bitmap/image/window item creation, text item editing and selection, raw and convenience find queries, discovery, tag management, tag event bindings, movement, absolute movement, coordinate conversion, coordinate scaling, scan-style drag scrolling, item z-order control, item configuration aliases, and scrolling view control, image-backed widget
