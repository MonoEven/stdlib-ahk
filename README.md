...
The covered GUI surface currently includes `Tk` roots with option configuration, visibility, state, iconify/deiconify,
...
当前已覆盖的 GUI 表面包括带选项配置、可见性、状态、最小化/恢复、几何尺寸与窗口尺寸 API 的 `Tk` 根窗口、带状态、最小化/恢复、几何尺寸与窗口尺寸 API 的 `Toplevel` 窗口、`Frame`、
