...
`Entry` cursor and selection state, focus management, event binding, bind-tag routing, virtual event registry queries, and synthetic event generation,
