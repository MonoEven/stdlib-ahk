...
`Frame`, `Label`, `LabelFrame`, `Message`, `Button`, `Menubutton`, `OptionMenu`, `Checkbutton`, `Radiobutton`, `Scale`, `Scrollbar`, `Menu`, `Entry`, `Spinbox`, `Listbox`, `Text`, and `Canvas` widgets,
