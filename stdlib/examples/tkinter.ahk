...
try {
    ...
    tkinter_example_canvas_line := tkinter_example_canvas.create_line(0, 1, 10, 20, { fill: "red", width: 2 })
    tkinter_example_canvas_rectangle := tkinter_example_canvas.create_rectangle(5, 6, 30, 40, { outline: "blue", fill: "green" })
